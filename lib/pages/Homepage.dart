...
import "package:gd_api_0298/client/BarangClient.dart";
import 'package:gd_api_0298/entity/Barang.dart';
import 'package:gd_api_0298/pages/EditBarang.dart';
  ...
  void onAdd(context, ref) {
    ...
    void onDelete(id, context, ref) async {
      try {
        ...
        showSnackBar(context, e.toString(), Colors.green);
      } catch (e) {
